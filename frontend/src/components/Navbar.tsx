    ...
    <>
      <div className="relative h-44 lg:h-96">
        ...
        <nav className="absolute left-0 top-0 flex h-full w-full justify-end p-4">
          <ul className="flex justify-end space-x-4 py-2 pr-4 lg:space-x-8 lg:py-4 lg:pr-10 lg:text-xl z-10">
            <li>
              <Link
        ...
        <h1 className="top-0 absolute flex h-full w-full pt-20 pl-36 justify-center align-center text-2xl lg:text-8xl lg:pt-40 lg:pl-60">Petrichor</h1>
